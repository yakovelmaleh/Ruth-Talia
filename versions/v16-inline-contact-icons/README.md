...
Version 16 removes footer SVG artwork entirely. Each contact row now uses a small text-sized symbol followed immediately by its email, phone, Instagram, or Facebook label.
...
```bash
cd /Users/yakovelmaleh/ruth-talia-couture-website/versions/v16-inline-contact-icons
npm install
...
1. Copy this whole `v16-inline-contact-icons` folder into a new project/version folder.
