...
Version 17 adds more space between footer symbols and labels, draws a compact Instagram camera mark with CSS, and refines the letter-sized Facebook mark.
...
```bash
cd /Users/yakovelmaleh/ruth-talia-couture-website/versions/v17-refined-social-icons
npm install
...
1. Copy this whole `v17-refined-social-icons` folder into a new project/version folder.
