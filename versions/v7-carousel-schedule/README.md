...
```bash
cd /Users/yakovelmaleh/ruth-talia-couture-website/versions/v7-carousel-schedule
npm install
...
1. Copy this whole `v7-carousel-schedule` folder into a new project/version folder.
