...
Version 15 removes fixed pixel dimensions from the footer icons. Icons use small text-relative `em` sizing and become slightly smaller again on mobile.
...
```bash
cd /Users/yakovelmaleh/ruth-talia-couture-website/versions/v15-relative-footer-icons
npm install
...
1. Copy this whole `v15-relative-footer-icons` folder into a new project/version folder.
