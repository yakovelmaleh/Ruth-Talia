...
Version 12 adds compact icons beside email, phone, Instagram, and Facebook in the footer. The collection-level `<` and `>` controls now match the other carousel controls with transparent backgrounds and no black boxes.
...
```bash
cd /Users/yakovelmaleh/ruth-talia-couture-website/versions/v12-footer-icons-clean-arrows
npm install
...
1. Copy this whole `v12-footer-icons-clean-arrows` folder into a new project/version folder.
