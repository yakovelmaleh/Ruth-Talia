...
Version 14 reduces the footer contact icons to subtle 8px symbols with lighter strokes and tighter spacing.
...
```bash
cd /Users/yakovelmaleh/ruth-talia-couture-website/versions/v14-micro-footer-icons
npm install
...
1. Copy this whole `v14-micro-footer-icons` folder into a new project/version folder.
